  ...
  return (
    <div className="bg-[#0D0F20] py-[3rem]">
      ...
      >
        <motion.div
          variants={fadeUp}
          className="max-w-7xl mx-auto backdrop-blur-md w-full bg-[#0d0f20cc] rounded-xl p-4"
        >
          <motion.div variants={fadeUp} className="text-center mt-[8rem] mb-16">
            <h3 className="text-5xl md:text-5xl sm:text-4xl xs:text-3xl font-bold text-white mb-4">
              Simple, transparent pricing
            </h3>
            <p className="text-xl md:text-lg sm:text-base text-zinc-300 max-w-2xl mx-auto mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-8 mb-20 w-full">
            {pricingData.map((plan, index) => {
              ...
              return (
                ...
                >
                  <Card
                    className={`w-full max-w-[450px] bg-[#0F172A] border border-zinc-700 text-white ${
                      isPopular
            ...
            <div className="hidden md:block overflow-x-auto">
              <table className="min-w-[800px] w-full border-collapse bg-[#0F172A] rounded-lg shadow-sm text-white">
                <thead>
                  ...
                  >
                    <th className="text-left p-4 font-semibold bg-[#0F172A]">
                      Features
                    </th>
                    {pricingData.map((plan) => (
                      <th
                        key={plan.name}
                        className="text-center p-4 font-semibold bg-[#0F172A] min-w-[120px]"
                      >
                        {plan.name}
                      </th>
                    ))}
                  ...
                  {comparisonData.map((category, categoryIndex) => (
                    <React.Fragment key={category.category}>
                      ...
                      >
                        <td
                          colSpan={5}
                          className="p-4 font-semibold bg-[#1a1f2e] text-sm uppercase tracking-wide"
                        >
                          {category.category}
                        </td>
                      </motion.tr>
                      {category.features.map((feature, featIndex) => (
                        ...
                        >
                          <td className="p-4 text-zinc-300 break-words">
                            {feature.name}
                          </td>
              ...
              {pricingData.map((plan, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="w-full"
                  >
                    <Card className="bg-[#0F172A] border border-zinc-700 text-white w-full max-w-[450px] m-auto">
