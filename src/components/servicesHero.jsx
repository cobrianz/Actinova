...
import servicesHeroData from "../lib/servicesSectionData";
...
export default function ServicesHero() {
  ...
  const BadgeIcon = iconMap[servicesHeroData.badge.icon];
    ...
    <section className="relative bg-gradient-to-br from-[#0a0b1a] via-[#0d0f20] to-[#1a0b2e] text-white py-48 overflow-hidden">
      ...
      >
        <div className="text-center mb-16">
          ...
          >
            {servicesHeroData.headline.main}{" "}
            <span className="bg-gradient-to-r from-[#7B68EE] to-[#9333EA] bg-clip-text text-transparent">
              {servicesHeroData.headline.highlight}
            </span>{" "}
            {servicesHeroData.headline.suffix}
          </motion.h1>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              {servicesHeroData.cta.primary.text}
              <ArrowRight
                size={20}
            ...
            >
              ...
              {servicesHeroData.cta.secondary.text}
            </motion.button>
          </motion.div>
        </div>
        ...
        >
          {servicesHeroData.stats.map((stat) => {
